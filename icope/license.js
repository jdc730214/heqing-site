...
;(async function () {
  ...
  const _pathCode = _pathSegs.length >= 2
    ...
    : null
  const urlCode = _hash || _pathCode || new URLSearchParams(window.location.search).get('code')
